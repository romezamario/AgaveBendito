...
$wshknumeropedidos = get_option('wshk_numeropedidos');
}
...
$pluginOptionsVal=get_wshk_sidebar_options();
$wshknumeropedidos = get_option('wshk_numeropedidos');
if ( $wshknumeropedidos != 0) {
$total_pages = ceil($total_records / $wshknumeropedidos);
} else {
    global $pluginOptionsVal;
$pluginOptionsVal=get_wshk_sidebar_options();
    $wshknumeropedidos = '15';
    $total_pages = ceil($total_records / $wshknumeropedidos);
}
...
<div class="pagination">
    <?php
    $args = array(
        'base' => @add_query_arg('page','%#%'). $wshkvieworderid,
        'format' => '?page=%#%',
        'total' => $total_pages,
        'current' => $paged,
        'show_all' => false,
